            ...
            Switch($Control.GetType()){
                ...
                ([System.Windows.Forms.Button]){
                    If($Control.Text -match "Font"){
                        ...
                        $TempCoords = ($Control.Text.Split(',')|%{[Int]$_})
        ...
        $Params | %{
            ...
            Switch($Type){
                ...
                'Point'{
                    ...
                    $Point.Top+=$OffSetY
                    $Point.Add_MouseUp({
                        $This.Text = [System.Windows.Forms.Cursor]::Position.ToString().Trim("{}").Replace("X=","").Replace("Y=","")
                    })
                    $Point.Add_MouseMove({
                        If([System.Windows.Forms.UserControl]::MouseButtons.ToString() -match 'Left'){
                            $PH = [System.Windows.Forms.Cursor]::Position
...
FillPie,System.Drawing.Brush brush,poitn loc,int width,int height,int startAngle,int sweepAngle
...
DrawImageUnscaled,System.Drawing.Image image,poitn loc,int width,int height
"
